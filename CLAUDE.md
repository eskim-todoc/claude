...
| **개발** | |
| [`[지침-개발] Git 브랜치·병합 규칙.md`](docs/[지침-개발]%20Git%20브랜치·병합%20규칙.md) | 브랜치 모델, 병합, Identity |
| [`[지침-개발] Git Workflow 플로우차트.md`](docs/[지침-개발]%20Git%20Workflow%20플로우차트.md) | 브랜치 흐름도·절차 다이어그램 |
| **프로그래밍** | |
| [`[지침-프로그래밍] 프로그래밍 작업 규칙.md`](docs/[지침-프로그래밍]%20프로그래밍%20작업%20규칙.md) | 문서 선행 → 승인 → 구현 |
| [`[지침-프로그래밍] 네이밍 컨벤션.md`](docs/[지침-프로그래밍]%20네이밍%20컨벤션.md) | C 코드 변수·함수·매크로·타입·파일 네이밍 |
