...
- actionable task 시 `EnterPlanMode` 자체 호출 (Plan Mode 자동 진입)
...
- 광범위 탐색·다중 가설·독립 작업 동시 실행 시 서브에이전트 **병렬 호출** 우선
...
| ↳ [`지침/일반/작업/완료처리.md`](docs/지침/일반/작업/완료처리.md) | core | 완료 시 list.md·모듈 현황.md 갱신 |
| [`지침/일반/계획 모드 자동 진입.md`](docs/지침/일반/계획%20모드%20자동%20진입.md) | stable | Plan Mode 자동 진입·②③ 단계 위 승인 게이트 |
| [`지침/일반/서브에이전트 활용.md`](docs/지침/일반/서브에이전트%20활용.md) | core | 병렬·효율 — 작업 패턴별 매핑·병렬 호출 |
...
| ↳ [`지침/일반/문서/폴더-구조.md`](docs/지침/일반/문서/폴더-구조.md) | stable | docs/ 2레벨·tasks·list.md·모듈 현황.md |
