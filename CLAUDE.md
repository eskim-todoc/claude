...
| [`[지침] 커뮤니케이션 규칙.md`](docs/[지침]%20커뮤니케이션%20규칙.md) | 존댓말 사용 등 |
| [`[지침] 문서 작성 규칙.md`](docs/[지침]%20문서%20작성%20규칙.md) | 기본 포멧(.md), 파일명 prefix 컨벤션 |
| [`[지침] 프로그래밍 작업 규칙.md`](docs/[지침]%20프로그래밍%20작업%20규칙.md) | 문서 선행 → 승인 → 구현 |
| [`[지침] Git 브랜치·병합 규칙.md`](docs/[지침]%20Git%20브랜치·병합%20규칙.md) | 브랜치 모델, 병합, Identity |
| [`[지침] Git Workflow 플로우차트.md`](docs/[지침]%20Git%20Workflow%20플로우차트.md) | 브랜치 흐름도·절차 다이어그램 |
| [`[지침] 네이밍 컨벤션.md`](docs/[지침]%20네이밍%20컨벤션.md) | C 코드 변수·함수·매크로·타입·파일 네이밍 |
