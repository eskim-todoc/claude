...
| ↳ | [`설정/Slack 알림.md`](설정/Slack%20알림.md) | stable | Stop 훅 Slack DM 알림 배선·트러블슈팅 | 알림 설정 시 |
| ↳ | [`설정/Statusline·스피너 설정.md`](설정/Statusline·스피너%20설정.md) | stable | 상태줄·스피너·언어 한글화 (사용자 홈) | 환경 재현 시 |
...
| ↳ | [`공통/경로·참조 표기.md`](공통/경로·참조%20표기.md) | stable | 상대/절대경로·크로스 repo·URL 인코딩·과거 tasks 소급 금지 | 링크·경로 작성 시 |
