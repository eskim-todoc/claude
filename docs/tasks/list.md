...
| tasks 구조 마이그레이션 (Task β) | meta | migration, tasks-structure, archive-removal, history-merge, list-unify | [meta/tasks-structure-migration](meta/tasks-structure-migration/) | 완료 | 2026-05-15 ~ 2026-05-15 | ← [meta/docs-structure-redesign](meta/docs-structure-redesign/) · ↔ [meta/permanent-docs-to-wiki](meta/permanent-docs-to-wiki/) (γ 병렬) | 5 repo 33 작업 archive 폐지 · 22 진행상황→이력 시계열 흡수 · 5 list.md 단일표 · 5 `_modules.md` 위치 이전 · 외부 인용 11 파일 갱신. **새 구조 첫 사용 사례** (Task α 자기 적용 면제 위임 수행). 5 repo Git 머지·push 완료 |
| 영속 콘텐츠 Wiki Vault 통합 (Task γ) | meta | migration, wiki-integration, permanent-docs, single-source | [meta/permanent-docs-to-wiki](meta/permanent-docs-to-wiki/) | 완료 | 2026-05-15 ~ 2026-05-15 | ← [meta/docs-structure-redesign](meta/docs-structure-redesign/) (Task α 정책 D) · ↔ [meta/tasks-structure-migration](meta/tasks-structure-migration/) (β 병렬) | 5 source repo `사용방법/`·`참고/` 26 콘텐츠 → Wiki Vault(`projects/wiki/사용방법/`·`참고/<도메인>/`) 이전 + frontmatter `source_repo` 확장 + 5 repo 폴더 폐지 + 외부 인용 5곳(루트·ez8300-study CLAUDE.md) + 6 repo Git. Wiki Vault 영속 단일 출처 시작 |
