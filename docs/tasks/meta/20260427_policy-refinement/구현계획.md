...
| 4.4 (갱신 이벤트) | 완료 시그널 동작에 `_archive 이동 + 이력 및 결과.md 작성 + list.md 행 갱신` 추가 |
...
### 4. `meta/20260424_docs-restructure/이력 및 결과.md` 백필
...
| 위험 | 완화 |
|---|---|
| `이력 및 결과.md` 형식이 지나치게 무거워져 작성 부담 증가 | 1페이지 cap, 4섹션만 (무엇/핵심결정/후속/메타) |
